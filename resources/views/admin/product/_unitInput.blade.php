...
<script>
    ...
    $(document).ready(function(){
        ...
        // $('.unit-name').on('change', function (e) {
        //     var valueSelected = this.value;
        //     $(".unit-price-label").text(valueSelected + "ละ")
        //     $(".unit-quantity-label").text(valueSelected)
        //     $(".quantity-per-unit-label").text("หนึ่ง" + valueSelected + "มี")
        // });
    });
</script>
