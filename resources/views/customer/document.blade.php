...
<div class="wrapper d-flex align-items-stretch">
    ...
    <nav id="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class="title">ข้อมูลเอกสาร</h5>
                ...
                <div class="col-md-12 col-lg-6">
                    <div class="row">
                        <div class="col-md-12">
                            <label class="mb-0 pb-2">รูปบัตรประชาชน <span class="required">*</span></label>
                            <div class="border mb-4 p-1 rounded @error('citizen_card_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        ...
                                        <input accept="image/x-png,image/gif,image/jpeg" name="citizen_card_image" type="file" class="hidden"
                        ...
                        <div class="col-md-12">
                            <label class="mb-0 pb-2">รูปใบประกอบโรคศิลปะ</label>
                            <div class="border mb-4 p-1 rounded @error('medical_license_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        <i class="fa fa-image"></i> อัพโหลดรูป
                                        <input accept="image/x-png,image/gif,image/jpeg" name="medical_license_image" type="file" class="hidden"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="border mb-4 p-1 rounded @error('commercial_register_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        <i class="fa fa-image"></i> อัพโหลดรูป
                                        <input accept="image/x-png,image/gif,image/jpeg" name="commercial_register_image" type="file" class="hidden"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="border mb-4 p-1 rounded @error('drug_store_approve_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        <i class="fa fa-image"></i> อัพโหลดรูป
                                        <input accept="image/x-png,image/gif,image/jpeg" name="drug_store_approve_image" type="file" class="hidden"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="border mb-4 p-1 rounded @error('juristic_person_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        <i class="fa fa-image"></i> อัพโหลดรูป
                                        <input accept="image/x-png,image/gif,image/jpeg" name="juristic_person_image" type="file" class="hidden"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="border mb-4 p-1 rounded @error('vat_register_cert_image') border-danger @enderror">
                                <div class="input-group">
                                    <label class="btn btn-primary">
                                        <i class="fa fa-image"></i> อัพโหลดรูป
                                        <input accept="image/x-png,image/gif,image/jpeg" name="vat_register_cert_image" type="file" class="hidden"
